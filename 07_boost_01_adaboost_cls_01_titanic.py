...
# -*- Coding: UTF-8 -*-
# @Time     :   2026/9/25 22:17
# @Author   :   Shawn
# @Version  :   Version 0.1.0
# @File     :   07_boost_01_adaboost_cls_01_titanic.py
# @Desc     :
...
def main() -> None:
    ...
    with FeaturesTransformer(train_features) as transformer:
        ...
        ****************************************************************
        ****************************************************************
        The function named 'tune_optimal_cls_degree' is starting (Adaboost):
        ----------------------------------------------------------------
        Polynomial Degree: 1, Weighted F1-Score: 0.7867
        Polynomial Degree: 2, Weighted F1-Score: 0.8062
        Polynomial Degree: 3, Weighted F1-Score: 0.8044
        ----------------------------------------------------------------
        Best Polynomial Degree: 2, Best F1-Score: 0.8062
        ----------------------------------------------------------------
        The function named 'tune_optimal_cls_degree' took 0.3007 seconds to complete.
        ****************************************************************
        """
        ...
        ****************************************************************
        ...
        status, pred_label = adaboost.inference(
